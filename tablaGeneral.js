...
(function() {
  ...
  style.textContent = `
    ...
    .tbl-gn thead tr { border-bottom: 1px solid rgba(0,180,255,0.3); }
    .tbl-gn thead th { font-size: 11px; font-weight: 700; color: rgba(0,180,255,0.6); letter-spacing: 2px; text-transform: uppercase; padding: 12px 10px; text-align: center; }
    ...
    .tbl-gn tbody tr:hover { background: rgba(0,180,255,0.05); }
    .tbl-gn tbody tr.row-lider { border-left: 3px solid #ff6b1a; }
    .tbl-gn tbody tr.row-clasificado { border-left: 3px solid #00b4ff; }
    .tbl-gn tbody tr.sep-lider td { border-top: 1px solid rgba(255,107,26,0.3); }
    .tbl-gn tbody tr.sep-clasificado td { border-top: 1px solid rgba(0,180,255,0.3); }
    ...
    .rank-1 { background: #ff6b1a; color: #3d2200; }
    .rank-2 { background: #c0c0c0; color: #1a1a1a; }
    .rank-3 { background: #cd7f32; color: #fff; }
    .rank-top { background: rgba(0,180,255,0.15); color: #00b4ff; border: 1px solid rgba(0,180,255,0.4); }
    ...
    .dg-pos { color: #00b4ff !important; font-weight: 700 !important; }
    ...
    .popup-card { background: #080c10; border: 2px solid #00b4ff; border-radius: 18px; padding: 24px 20px; width: 85%; max-width: 340px; box-shadow: 0 0 30px rgba(0,180,255,0.3); position: relative; }
    ...
    .popup-header { display: flex; align-items: center; gap: 12px; margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1px solid rgba(0,180,255,0.2); }
    ...
    .popup-rank { font-size: 12px; color: rgba(0,180,255,0.7); margin-top: 3px; }
    ...
    .popup-stat-val.green { color: #00b4ff; }
    ...
    .popup-pts { margin-top: 14px; text-align: center; background: rgba(0,180,255,0.08); border: 1px solid rgba(0,180,255,0.3); border-radius: 12px; padding: 12px; }
    .popup-pts-val { font-size: 32px; font-weight: 900; color: #00b4ff; line-height: 1; }
